...
import dev.december.jeterbackend.supplier.features.suppliers.domain.errors.CalendarNotFoundFailure
import dev.december.jeterbackend.supplier.features.suppliers.domain.errors.SupplierNotFoundFailure
...
//                    return@withContext Data.Error(AppointmentNotFoundFailure())
                ...
                Data.Success(Unit)//appointmentEntity.appointment()
            }
        } catch (e: Exception) {

package dev.december.jeterbackend.supplier.features.files.domain.services
...
interface FileService {
    suspend fun storeFile(directory: FileDirectory, part: FilePart, priority: Int): Data<File>

...
) : UseCase<GetAppointmentsParams, Map<LocalDate, List<ClientTour>>> {
    override suspend fun invoke(params: GetAppointmentsParams): Data<Map<LocalDate, List<ClientTour>>> {

...
import dev.december.jeterbackend.client.core.config.security.firebase.FirebaseHeadersExchangeMatcher
import dev.december.jeterbackend.client.core.config.security.firebase.FirebaseTokenAuthenticationManager
import dev.december.jeterbackend.client.features.authorization.domain.usecases.SaveSessionUserUseCase
...
class SecurityConfig(
    ...
    fun springSecurityFilterChain(
        ...
        http.exceptionHandling()
            ...
            .and()
            .authorizeExchange()
            .pathMatchers(HttpMethod.POST, *securityProperties.allowedPostPublicApis.toTypedArray()).permitAll()
            .and()
